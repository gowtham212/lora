...
const char *ssid = "gowtham";  //ENTER YOUR WIFI SETTINGS
...
void loop() {
  ...
  if (packetSize) {
    ...
    while (LoRa.available()) {
      ...
      String postData;
      //Post Data
      postData = "temperature=" + String(b2) + "&current=" + (b7) + "&humidity=" + String(b4) + "&pressure=" + String(b6) + "&dust=" + String(b5) + "&lux=" + String(b3) + "&pt100=" + String(b1) + "&ktype=" + String(b8) + "&ktype1=" + String(b9) + "&pressure1=" + String(b10);


      http.begin("https://adc.bitsathy.ac.in/projects/rstahl/copies-for-sql-server/insert.php");              //Specify request destination
